...
class AnswerSalary():
    ...
    def charged_answers_salary(self):
        for charge_answer in self.charge_answers:
            s = self.__charged_salary(charge_answer)
            charge_answer.update({'salary':s})
        #return self.charge_answers
    ...
    def free_answers_salary(self):
        ...
        for free_answer in self.free_answers:
            s = self.__free_salary(free_answer)
            free_answer.update({'salary':s})
        #return self.free_answers
...
class SalarySheet():
    ...
    def to_dataFrame(self,dict_list):
        to_list = []
    ...
    def salary_sheet(self):
        all_answers_df = self.to_dataFrame(self.answers)
        ...
        teacher_info_salary.to_html(self.html)
